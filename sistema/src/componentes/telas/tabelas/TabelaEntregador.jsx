    ...
    return (
        <>
            <Container className='text-center'>
                <Button className='mb-3' variant='secondary' style={{borderColor:'black'}}onClick={() => {
                            ...
                            props.listaDeEntregadores?.map((entregador) => {
                                return (
                                    <tr>
                                        ...
                                        <td><img style={{ "height": "50px", "width": "90px" }} src={entregador.fotoCnh} alt="foto da CNH" /></td>
                                        <td>{entregador.veiculo}</td>
                                        <td>{entregador.placaV}</td>
                                        <td>{entregador.capacidadeMax}</td>
                                        <td>
                                            <Button onClick={() => {
                                                props.setExibirTabela(false);
