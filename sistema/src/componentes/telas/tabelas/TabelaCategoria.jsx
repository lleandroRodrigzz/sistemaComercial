...
import { deletarCategoria } from '../../../servicos/servicoCategoria'
...
export default function TabelaCategoria(props) {
    ...
    return (
        <>
            ...
            Quantidade de Categorias Cadastradas: <span style={{color:"#1BFD9C"}}>{props.listaDeCategorias.length}</span>
